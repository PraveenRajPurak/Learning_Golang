...
import (
	...
	"github.com/PraveenRajPurak/Learning_Golang/Day_3/BackendwithGo/modules/auth"
	...
	"github.com/PraveenRajPurak/Learning_Golang/Day_3/BackendwithGo/modules/database/query"
	"github.com/PraveenRajPurak/Learning_Golang/Day_3/BackendwithGo/modules/encrypt"
	...
	return func(ctx *gin.Context) {
		...
		if ok {
			...
			case verified:
				...
				_, updateErr := ga.DB.UpdateUser(id, tk)
